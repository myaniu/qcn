...
/bin/rm -f $LOCAL_FILE
/bin/nice -n19 /usr/local/mysql/bin/mysqldump -u root -p1QCNQuake --single-transaction --databases qcnwp sensor continual mysql sensor_download continual_download todolist information_schema > $LOCAL_FILE
