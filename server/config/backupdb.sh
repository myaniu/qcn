...
##/bin/nice -n19 /usr/local/mysql/bin/mysqldump -u root -p1QCNQuake --all-databases > /data/cees2/QCN/qcn-backup.sql
/bin/nice -n19 /usr/local/mysql/bin/mysqldump -u root -p1QCNQuake --databases qcnalpha continual mysql sensor_download continual_download qcn_ecommerce todolist information_schema drupal > /tmp/qcn-backup.sql
