...
/bin/rm -f $LOCAL_FILE
/bin/nice -n19 /usr/local/mysql/bin/mysqldump -u root -p1QCNQuake --single-transaction --databases qcnalpha continual mysql sensor_download continual_download qcn_ecommerce todolist information_schema drupal > $LOCAL_FILE
