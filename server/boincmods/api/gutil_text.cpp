...
#else
// CMC implementation to get rid of the last remaining glut requirements in BOINC
// these two functions will rely on the textfont stuff that Tolu put into BOINC
// and requires that you've at least loaded the Helvetica.txf font with the
// txf_load_fonts(char* dir) call 
// see txf_util.* and textfont.* (.cpp & .h)
// 
