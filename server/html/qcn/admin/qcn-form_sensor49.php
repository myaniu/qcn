...
<div id="container">
  ...
  <form action="confirm.php" method="post" id="qcnpurchase">
    <fieldset>
      ...
      <label>Intl Ordering</label>
      <select name="domestic" id="domestic">
          <option selected="selected" value="domestic">USA/Canada</option> <option value="intl">Other</option>
      </select>
      <cite><em>A $10 surcharge for international shipping will be added to orders outside USA/Canada.</em></cite>
      ...
      <div id="intl_form" style="display:none;">
      <label>Province</label>
      <input type="text" name="STATE2" id="billstate2" />
      <label>Postal Code</label>
      <input type="text" name="ZIP2" id="billzip2" />
      <label>Country</label>
      <input type="text" name="COUNTRY2" id="billcountry2" />
      </div>
    </fieldset>
    ...
    <fieldset>
      ...
      <div id="intl_form2" style="display:none;">
      <label>Province</label>
      <input type="text" name="STATETOSHIP2" id="shipstate2" />
      <label>Postal Code</label>
      <input type="text" name="ZIPTOSHIP2" id="shipzip2" />
      <label>Country</label>
      <input type="text" name="COUNTRYTOSHIP2" id="shipcountry2" />
      </div>
    </fieldset>
    ...
    <fieldset>       
      ...
      <p style="font-size:70%;"> &nbsp; @ $49.00 / sensor <span id="surcharge" style="display:none">plus $10.00 surcharge</span></p>
