#ifndef _CSENSOR_MAC_USB_GENERIC_H_
#define _CSENSOR_MAC_USB_GENERIC_H_

/*
 *  csensor_mac_usb_generic.h
 *  qcn
 *
...
class CSensorMacUSBGeneric  : public CSensor
{
   private:
      ...
      bool writePipeState(const int iSeconds, const int iMicroSeconds = 0);
      bool readPipeSensor(const int iSeconds, const int iMicroSeconds = 0);
