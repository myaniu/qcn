...
**
** Created: Sat Jan 5 12:48:33 2013
...
struct qt_meta_stringdata_CDialogMakeQuake_t {
    QByteArrayData data[3];
    char stringdata[27];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_CDialogMakeQuake_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_CDialogMakeQuake_t qt_meta_stringdata_CDialogMakeQuake = {
    {
QT_MOC_LITERAL(0, 0, 16),
QT_MOC_LITERAL(1, 17, 7),
QT_MOC_LITERAL(2, 25, 0)
    },
    "CDialogMakeQuake\0onStart\0\0"
};
...
const QMetaObject CDialogMakeQuake::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_CDialogMakeQuake.data,
      qt_meta_data_CDialogMakeQuake,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CDialogMakeQuake.stringdata))
