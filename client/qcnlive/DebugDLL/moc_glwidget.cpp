...
**
** Created: Sat Jan 5 13:36:21 2013
...
QT_MOC_LITERAL(5, 45, 15)
    ...
    "GLWidget\0TimePositionChanged\0\0dValue\0"
    "animate\0setTimePosition\0"
};
...
void GLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (GLWidget::*_t)(const double & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GLWidget::TimePositionChanged)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void GLWidget::TimePositionChanged(const double & _t1)
{
