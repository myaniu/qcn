...
**
** Created: Sat Jan 5 13:36:20 2013
...
struct qt_meta_stringdata_CDialogSettings_t {
    QByteArrayData data[3];
    char stringdata[25];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_CDialogSettings_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_CDialogSettings_t qt_meta_stringdata_CDialogSettings = {
    {
QT_MOC_LITERAL(0, 0, 15),
QT_MOC_LITERAL(1, 16, 6),
QT_MOC_LITERAL(2, 23, 0)
    },
    "CDialogSettings\0onSave\0\0"
};
...
const QMetaObject CDialogSettings::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_CDialogSettings.data,
      qt_meta_data_CDialogSettings,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CDialogSettings.stringdata))
