...
QMAKE    = /usr/bin/qmake
qcnlive.xcodeproj/project.pbxproj: qcnlive.pro ../../.qmake.cache /usr/local/Qt4.7/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.7/mkspecs/common/unix.conf \
	...
	$(QMAKE) -spec /usr/local/Qt4.7/mkspecs/macx-xcode -o qcnlive.xcodeproj/project.pbxproj qcnlive.pro
