...
GetGLProcs()
{
    ...
    if (strstr((char*) strExtensions, "GL_ARB_multitexture") == 0) {
        fprintf(stdout, "GL_ARB_multitexture NOT found.\n");
        multitexturing = 0;
        return;
    }
...
Display(void)
{
    ...
    if (multitexturing && glActiveTextureARB) {
